...
<h1 class="c-admin-DELETE-tour-dates-title">Delete News Story</h1>
...
while ($delNewsStory_rs = mysqli_fetch_array($delNewsStory_query)){ ?>
 	...
 	<article class="c-news-stories-DELETE-container">
 		...
 		<div class="c-news-stories-DELETE-container-for-anchor-cover h-position c-latest-news-img-container">
 	  	...
 	  	<img class="c-news-stories-DELETE-img-itself" src="../img/<?php echo $delNewsStory_rs ['img_ref'];?>" />
...
<a class="c-news-stories-DELETE-links-bbc" href="deleteNewsStoryConfirm.php?newsID=<?php echo $delNewsStory_rs['id'];?>">
