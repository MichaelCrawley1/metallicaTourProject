...
$row = mysqli_fetch_array($delTourDates_query);
...
<!-- these links take out their decoration but colour the text our white -->
  <a class="c-admin-confirm-addDeleteOrEdit-to-db-links" href="defDeleteTour.php?tourID=<?php echo $_GET['tourID'];?>">Yes, delete it!</a>
  <!-- end of colour the text our white-->
  <!-- these links take out their decoration but colour the text our white -->
   |
<a href="deleteTourDates.php" class="c-admin-confirm-addDeleteOrEdit-to-db-links">No, go back</a>
  <!-- end of colour the text our white-->
  <!-- these links take out their decoration but colour the text our white -->
