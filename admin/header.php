            ...
            <nav class="c-fixed-mobile-screen-nav-menu">
                ...
                <ul class="c-fixed-mobile-screen-nav-menu-list h-grid">
                    ...
                    <li class="c-fixed-mobile-screen-nav-menu-list-item h-grid h-position">
                        ...
                        <a href="../public/project.php" id="c-fixed-home" class="c-fixed-mobile-screen-list-item-links ">Home</a>
                    ...
                    <li class="c-fixed-mobile-screen-nav-menu-list-item h-grid h-position">
                        ...
                        <a href="../public/aboutus.php" class="c-fixed-mobile-screen-list-item-links">about us</a>
                    ...
                    <li class="c-fixed-mobile-screen-nav-menu-list-item h-grid h-position">
                          <!-- see comments for the destination anchor links under the first list item -->
                        <a href="../public/tour.php" class="c-fixed-mobile-screen-list-item-links">tour</a>
                    ...
                    <li class="c-fixed-mobile-screen-nav-menu-list-item h-grid h-position ">
                          <!-- see comments for the destination anchor links under the first list item -->
                        <a href="../public/news.php" class="c-fixed-mobile-screen-list-item-links">news</a>
                    ...
                    <li class="c-fixed-mobile-screen-nav-menu-list-item h-grid h-position  ">
                        ...
                        <a href="../public/music.php" class="c-fixed-mobile-screen-list-item-links">music</a>
                    ...
                    <li class="c-fixed-mobile-screen-nav-menu-list-item h-grid h-position ">
                        ...
                        <a href="../public/photos.php" class="c-fixed-mobile-screen-list-item-links">photos</a>
...
<!-- MODIFIER HERE, PLEASE SEE CSS COMMENTS FOR WHAT THIS DOES OR WHAT IT IS FOR -->
                    <li class="c-fixed-mobile-screen-nav-menu-list-item h-grid c-fixed-mobile-screen-nav-menu-list-item--no-border h-position ">
                        ...
                        <a href="admin.php" class="c-fixed-mobile-screen-list-item-links">admin</a>
                ...
                <nav class="c-big-screen-nav">
                    ...
                    <ul class="c-big-screen-nav-list h-flex">
                        ...
                        <li class="c-big-screen-nav-list-item">
                            ...
                            <a href="../public/project.php" id="c-fixed-home" class="c-big-screen-list-item-links ">Home </a>
                            <!-- end of big screen page links with some style requirements -->
                        </li>
                        <!-- end of the horizontal padding -->
                        <!-- just a little horizontal padding here -->
                        <li class="c-big-screen-nav-list-item">
                             <!-- big screen page links with some style requirements --><a href="../public/aboutus.php" class="c-big-screen-list-item-links">About Us</a>
                              <!-- end of big screen page links with some style requirements -->
                         </li>
                          <!-- end of the horizontal padding -->
                        <!-- just a little horizontal padding here -->
                        <li class="c-big-screen-nav-list-item">
                              <!-- big screen page links with some style requirements -->
                            <a href="../public/tour.php" class="c-big-screen-list-item-links">Tour</a>
                            <!-- end of big screen page links with some style requirements -->
                        ...
                        <li class="c-big-screen-nav-list-item">
                             <!-- big screen page links with some style requirements -->
                            <a href="../public/news.php" class="c-big-screen-list-item-links">News</a>
                             <!-- end of big screen page links with some style requirements -->
                        </li>
                         <!-- end of the horizontal padding -->
                        <!-- just a little horizontal padding here -->
                        <li class="c-big-screen-nav-list-item">
                             <!-- big screen page links with some style requirements -->
                            <a href="../public/music.php" class="c-big-screen-list-item-links">Music</a>
                            <!-- end of big screen page links with some style requirements -->
                        </li>
                         <!-- end of the horizontal padding -->
                        <!-- just a little horizontal padding here -->
                        <li class="c-big-screen-nav-list-item">
                              <!-- big screen page links with some style requirements -->
                            <a href="../public/photos.php" class="c-big-screen-list-item-links">Photos</a>
                             <!-- end of big screen page links with some style requirements -->
                        ...
                        <li class="c-big-screen-nav-list-item">
                            <!-- big screen page links with some style requirements -->
                            <a href="admin.php" class="c-big-screen-list-item-links">Admin</a>
                             <!-- end of big screen page links with some style requirements -->
                        </li>
                         <!-- end of the horizontal padding -->
                        <!-- just a little horizontal padding here -->
