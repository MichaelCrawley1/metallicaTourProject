...
<h1 class="c-admin-editAndDelete-item-title">Edit Band Photo</h1>
...
while($row= mysqli_fetch_array($editBandPhoto_query)){ 

require($_SERVER['DOCUMENT_ROOT']."/metallicaTourProject/public/theLoops/theBandPhotoLoops/bandPhotosWhileLoopEditItem.php");
