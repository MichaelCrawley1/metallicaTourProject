...
<h1 class="c-admin-editAndDelete-item-title">Select News Story To change</h1>
...
while($row = mysqli_fetch_array($editNewsStory_query)){ 

  require($_SERVER['DOCUMENT_ROOT']."/metallicaTourProject/public/theLoops/theNewsLoops/newsStoriesWhileLoopEditItem.php");
