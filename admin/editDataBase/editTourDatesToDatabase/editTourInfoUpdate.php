...
$date = $_SESSION['editTourDateInfo']['date'];
$venue =  $_SESSION['editTourDateInfo']['venue'];
$state_country = $_SESSION['editTourDateInfo']['state_country'];
 

$editTour_sql="UPDATE Tour_table SET date='".$date."', venue = '" .$venue."', state_country = '".$state_country."'WHERE ID=".$_SESSION['editTourDateInfo']['tourID'];
...
<h1 class="c-admin-confirmation-page-title">Tour Date details have successfully been updated and changed!!!!</h1>
