...
<section class="c-admin-add-tour-dates h-flex h-position">
    ...
    <div class="c-back-page-icon-container">
        ...
        <a href="addBandPhotos.php" class="c-back-page-icon-link"></a>
    </div>
...
if($_FILES["fileToUpload"]["name"]!=""){
	 ...
	 $_SESSION['addBandPhotos']['img'] = $_FILES["fileToUpload"]["name"];
...
<p class="c-admin-confirm-add-tour-desc">
     | <a class="c-admin-confirm-add-tour-desc-links" href="addBandPhotos.php">Ooops, go back</a> | <a class="c-admin-confirm-add-tour-desc-links" href="admin.php">Back to admin panel</a>
    </p>
</div>
...
// if everything is ok, try to upload file
  ...
  <article class="c-latest-news-articles h-flex h-padding c-latest-news-articles--for-confirm-add-news-story">
     ...
     <div class="c-latest-news-articles-photo-container">Image Ref:
        <img src="../img/<?php echo $_SESSION['addBandPhotos']['img']; ?>" class="c-latest-news-articles-photo-img"/>
      </div>

      <div class="c-news-stories-DELETE-info-container ">
            <div class="c-news-stories-DELETE-date"><?php echo $_SESSION['addBandPhotos']['date']?>
        </div>
        <!---this class is from the tour section, just testing this what it looks like--->
        <div class="c-upcoming-shows-location"> <?php echo $_SESSION['addBandPhotos']['state_country']?> </div> 
...
<div class="c-admin-confirm-add-tour-desc-container h-flex">
<p class="c-admin-confirm-add-tour-desc"><a href="enterNewBandPhoto.php" class="c-admin-confirm-add-tour-desc-links">Correct, continue</a>
     | <a class="c-admin-confirm-add-tour-desc-links" href="addBandPhotos.php">Ooops, go back</a> | <a class="c-admin-confirm-add-tour-desc-links" href="admin.php">Back to admin panel</a>
    </p>
</div>
