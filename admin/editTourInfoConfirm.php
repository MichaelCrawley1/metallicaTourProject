...
<!-- these links take out their decoration but colour the text our white -->
  <a href="editTourInfoUpdate.php" class="c-admin-confirm-addDeleteOrEdit-to-db-links">Correct, continue </a>

  <!-- end of colour the text our white-->
  <!-- these links take out their decoration but colour the text our white -->

   |<a href="editTourInfo.php" class="c-admin-confirm-addDeleteOrEdit-to-db-links"> Oops, go back</a>
...
<!-- end of the grid having less rows than the home page -->
</body>
</html>
