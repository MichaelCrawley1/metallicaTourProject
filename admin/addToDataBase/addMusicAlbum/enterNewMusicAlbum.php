...
$image = mysqli_real_escape_string($dbc, $_SESSION['addMusic']['img']);
...
$enter_sql="INSERT INTO music_table (id, img_ref) VALUES (NULL ,'$image')";
$enter_query= mysqli_query($dbc, $enter_sql);
 

// Unset the addNews session

unset($_SESSION['addMusic']);
...
<h1 class="c-admin-confirmation-page-title">New Album cover has been entered!!!</h1>
