...
$date = mysqli_real_escape_string($dbc, $_SESSION['addNewsStory']['date']);
$title = mysqli_real_escape_string($dbc, $_SESSION['addNewsStory']['title']);

$description = mysqli_real_escape_string($dbc, $_SESSION['addNewsStory']['description']);

$image = mysqli_real_escape_string($dbc, $_SESSION['addNewsStory']['img']);
...
<h1 class="c-admin-confirmation-page-title">New News Story has been entered!!!</h1>
