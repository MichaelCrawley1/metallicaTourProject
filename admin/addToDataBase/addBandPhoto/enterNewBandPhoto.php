...
// Add new band photo to database
require_once ($_SERVER['DOCUMENT_ROOT']."/metallicaTourProject/connect_database.php");

$dbc = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME) or die('Error connecting to MySQL server.');

$image = mysqli_real_escape_string($dbc, $_SESSION['addBandPhotos']['img']);


$state_country = mysqli_real_escape_string($dbc, $_SESSION['addBandPhotos']['state_country']);

$date =  mysqli_real_escape_string($dbc,$_SESSION['addBandPhotos']['date']);
...
$enter_sql="INSERT INTO photo_table (id,img_ref,state_country, date) VALUES (NULL,'$image', '$state_country','$date')";
$enter_query= mysqli_query($dbc, $enter_sql);
 

// Unset the addNews session

unset($_SESSION['addBandPhotos']);
...
<h1 class="c-admin-confirmation-page-title">New Band Photo has been entered!!!</h1>
...
<!--  end of the admin grid which has less rows than the UI home design -->
</body>
</html>
