...
$delTourDates_sql = "SELECT * FROM Tour_table";
...
require($_SERVER['DOCUMENT_ROOT']."/metallicaTourProject/public/theLoops/theTourLoops/tourDatesWhileLoopDeleteItem.php");
