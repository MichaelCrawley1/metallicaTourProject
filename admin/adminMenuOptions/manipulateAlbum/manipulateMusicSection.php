...
<p class="c-admin-manipulate-website-sections-desc ">
 ...
 <!-- the style on the text comes from the link here not the paragraph element, font size, text decoration etc -->
    ...
    <a href="/metallicaTourProject/admin/addToDataBase/addMusicAlbum/addMusicAlbums.php" class="c-admin-manipulate-website-sections-desc-links">
Add Music Albums</a>
...
<p class="c-admin-manipulate-website-sections-desc">
    ...
    <a href="/metallicaTourProject/admin/deleteFromDataBase/deleteMusicAlbum/delMusicAlbums.php" class="c-admin-manipulate-website-sections-desc-links">
Delete Music Albums</a>
