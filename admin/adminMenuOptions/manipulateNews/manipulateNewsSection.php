...
<!-- the style on the text comes from the link here not the paragraph element, font size, text decoration etc -->
    ...
    <a href="/metallicaTourProject/admin/addToDataBase/addNewsStoryToDataBase/addNewsDesAImage.php" class="c-admin-manipulate-website-sections-desc-links">
Add News Story</a>
...
<p class="c-admin-manipulate-website-sections-desc">
    ...
    <a href="/metallicaTourProject/admin/deleteFromDataBase/deleteNewsStoryFromDataBase/deleteNewsStory.php" class="c-admin-manipulate-website-sections-desc-links">
Delete News Story</a>
...
<p class="c-admin-manipulate-website-sections-desc">
    ...
    <a href="/metallicaTourProject/admin/editDataBase/editNewsStoryToDataBase/editNewsStorySelect.php" class="c-admin-manipulate-website-sections-desc-links">Edit News Stories</a>
