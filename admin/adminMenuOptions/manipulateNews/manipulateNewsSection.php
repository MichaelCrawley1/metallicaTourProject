...
<!--- below is a base component (the arrow to go back to a page)---->
...
<div class="c-admin-manipulate-website-sections-paragraph-container h-flex">
    <p class="c-admin-manipulate-website-sections-message">
        ...
        Administrator, you are behind the scenes in the news section of the website, here you can make the changes that is needed.  What would you like to change?
    ...
    <!---below is the news pages options to change---->
    
<div class="c-admin-manipulate-website-sections-list-container h-flex">
<p class="c-admin-manipulate-website-sections-desc "><a href="/metallicaTourProject/admin/addToDataBase/addNewsStoryToDataBase/addNewsDesAImage.php" class="c-admin-manipulate-website-sections-desc-links">
Add News Story</a></p>

<p class="c-admin-manipulate-website-sections-desc"><a href="/metallicaTourProject/admin/deleteFromDataBase/deleteNewsStoryFromDataBase/deleteNewsStory.php" class="c-admin-manipulate-website-sections-desc-links">
Delete News Story</a></p>

<p class="c-admin-manipulate-website-sections-desc"><a href="/metallicaTourProject/admin/editDataBase/editNewsStoryToDataBase/editNewsStorySelect.php" class="c-admin-manipulate-website-sections-desc-links">Edit News Stories</a></p>

</div>

<!---end of news page options---->
