...
<div class="c-admin-manipulate-website-sections-paragraph-container h-flex">
    <p class="c-admin-manipulate-website-sections-message">
        ...
        Administrator, you are behind the scenes in the tour section of the website, here you can make the changes that is needed.  What would you like to change?
    ...
    <!---below is the tour pages options to change---->
    
<div class="c-admin-manipulate-website-sections-list-container h-flex">
<p class="c-admin-manipulate-website-sections-desc "><a href="/metallicaTourProject/admin/addToDataBase/addTourDate/addTourDates.php" class="c-admin-manipulate-website-sections-desc-links">
Add Tour Dates</a></p>

<p class="c-admin-manipulate-website-sections-desc"><a href="/metallicaTourProject/admin/deleteFromDataBase/deleteTourDates/deleteTourDates.php" class="c-admin-manipulate-website-sections-desc-links">
Delete Tour Dates</a></p>

<p class="c-admin-manipulate-website-sections-desc"><a href="/metallicaTourProject/admin/editDataBase/editTourDatesToDatabase/editTourDateSelect.php" class="c-admin-manipulate-website-sections-desc-links">Edit Tour Information</a></p>

</div>

<!---end of tour page options---->
