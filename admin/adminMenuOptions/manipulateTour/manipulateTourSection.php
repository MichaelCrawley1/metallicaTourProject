...
<a href="/metallicaTourProject/admin/addToDataBase/addTourDate/addTourDates.php" class="c-admin-manipulate-website-sections-desc-links">
Add Tour Dates</a>
...
<p class="c-admin-manipulate-website-sections-desc">
 ...
 <!-- the style on the text comes from the link here not the paragraph element, font size, text decoration etc -->
    ...
    <a href="/metallicaTourProject/admin/deleteFromDataBase/deleteTourDates/deleteTourDates.php" class="c-admin-manipulate-website-sections-desc-links">
Delete Tour Dates</a>
...
<!-- the style on the text comes from the link here not the paragraph element, font size, text decoration etc -->
    ...
    <a href="/metallicaTourProject/admin/editDataBase/editTourDatesToDatabase/editTourDateSelect.php" class="c-admin-manipulate-website-sections-desc-links">Edit Tour Information</a>
