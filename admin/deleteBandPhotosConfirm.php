...
<section class="c-admin-DELETE-tour-dates-CONFIRM h-flex h-position">
  ...
  <!----reusable component icon to go back a page----->
    <div class="c-back-page-icon-container">
        ...
        <a href="delBandPhotos.php" class="c-back-page-icon-link"></a>
    </div>
<!----end of reusable component----->

<h1 class="c-admin-DELETE-tour-dates-CONFIRM-title">Confirm Band Photo Deletion</h1>
...
$delPhoto_sql="SELECT * FROM photo_table WHERE id=".$_GET['photoID'];

$delPhoto_query= mysqli_query($dbc, $delPhoto_sql)
or die('Error querying database.');
$delPhoto_rs = mysqli_fetch_array($delPhoto_query);
...
<article class="c-latest-news-articles h-flex c-latest-news-articles--for-confirm-add-news-story">
 	  ...
 	  <div class="c-latest-news-articles-photo-container">
 	  	<img src="../img/<?php echo $delPhoto_rs['img_ref']?>" class="c-latest-news-articles-photo-img"/>
 	  </div>


	<div class="c-news-stories-DELETE-info-container ">
 	  		<div class="c-news-stories-DELETE-date"><?php echo $delPhoto_rs['date']?>
 	  	</div>
 	  	<!---this class is from the tour section, just testing this what it looks like--->
 	  	<div class="c-upcoming-shows-location"> <?php echo $delPhoto_rs['state_country']?>  </div> 
...
<p class="c-admin-confirm-add-tour-desc"><a class="c-admin-confirm-add-tour-desc-links" href="defDeleteBandPhotos.php?photoID=<?php echo $_GET['photoID'];?>">Yes, delete it!</a> |
<a href="delBandPhotos.php" class="c-admin-confirm-add-tour-desc-links">No, go back</a> | <a href="admin.php" class="c-admin-confirm-add-tour-desc-links">Back to control panel</a></p>
