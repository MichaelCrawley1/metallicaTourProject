...
<h1 class="c-admin-confirm-addDeleteOrEdit-to-db-title">Confirm Band Photo Deletion</h1>
...
$row = mysqli_fetch_array($delPhoto_query);

require('../public/bandPhotosWhileLoopCentre.php');
...
<!-- these links take out their decoration but colour the text our white -->
  ...
  <a class="c-admin-confirm-addDeleteOrEdit-to-db-links" href="defDeleteBandPhotos.php?photoID=<?php echo $_GET['photoID'];?>">Yes, delete it!</a>
...
<a href="delBandPhotos.php" class="c-admin-confirm-addDeleteOrEdit-to-db-links">No, go back</a> 
<!-- end of colour the text our white-->
  <!-- these links take out their decoration but colour the text our white -->
