...
$state_country = $_SESSION['editBandPhotoInfo']['state_country'];
 $date = $_SESSION['editBandPhotoInfo']['date'];
 

$editPhotoInfo_sql="UPDATE photo_table SET state_country= '".$state_country."', date = '".$date."'   WHERE id =".$_SESSION['editBandPhotoInfo']['photoID'];



$editPhotoInfo_query= mysqli_query($dbc, $editPhotoInfo_sql);
...
<h1 class="c-admin-confirmation-page-title">Band Photos have successfully been updated and changed!!!!</h1>
