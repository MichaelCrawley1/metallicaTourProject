...
<section class="c-admin-add-tour-dates h-flex h-position">
    ...
    <div class="c-back-page-icon-container">
        ...
        <a href="addMusicAlbums.php" class="c-back-page-icon-link"></a>
    </div>
...
if($_FILES["fileToUpload"]["name"]!=""){
     ...
     $_SESSION['addMusic']['img'] = $_FILES["fileToUpload"]["name"];
...
<p class="c-admin-confirm-add-tour-desc">
     | <a class="c-admin-confirm-add-tour-desc-links" href="addMusicAlbums.php">Ooops, go back</a> | <a class="c-admin-confirm-add-tour-desc-links" href="admin.php">Back to admin panel</a>
    </p>
</div>
...
// if everything is ok, try to upload file
  ...
  <article class="c-latest-news-articles h-flex h-padding">
     ...
     <div class="c-latest-news-articles-photo-container">Image Ref:
        <img src="../img/<?php echo $_SESSION['addMusic']['img']; ?>" class="c-latest-news-articles-photo-img"/>
      </div>
...
<div class="c-admin-confirm-add-tour-desc-container h-flex">
<p class="c-admin-confirm-add-tour-desc"><a href="enterNewMusicAlbum.php" class="c-admin-confirm-add-tour-desc-links">Correct, continue</a>
     | <a class="c-admin-confirm-add-tour-desc-links" href="addMusicAlbums.php">Ooops, go back</a> | <a class="c-admin-confirm-add-tour-desc-links" href="admin.php">Back to admin panel</a>
    </p>
</div>
