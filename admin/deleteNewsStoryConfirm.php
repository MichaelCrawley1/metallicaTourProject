...
<h1 class="c-admin-confirm-addDeleteOrEdit-to-db-title">Confirm News Story Deletion</h1>
...
$row = mysqli_fetch_array($delNewsStory_query);

require("../public/newsStoriesWhileLoopCentreConfirmation.php");
...
<!-- these links take out their decoration but colour the text our white -->
  <a class="c-admin-confirm-addDeleteOrEdit-to-db-links" href="defDeleteNewsStory.php?newsID=<?php echo $_GET['newsID'];?>">Yes, delete it!</a>
...
<a href="deleteNewsStory.php" class="c-admin-confirm-addDeleteOrEdit-to-db-links">No, go back</a>
<!-- end of colour the text our white-->
  <!-- these links take out their decoration but colour the text our white -->
 | 

 <a href="admin.php" class="c-admin-confirm-addDeleteOrEdit-to-db-links">Back to control panel</a>
 <!-- end of colour the text our white-->
