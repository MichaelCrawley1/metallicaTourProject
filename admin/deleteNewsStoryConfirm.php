...
<section class="c-admin-DELETE-tour-dates-CONFIRM h-flex h-position">
  ...
  <!----reusable component icon to go back a page----->
    <div class="c-back-page-icon-container">
        ...
        <a href="deleteNewsStory.php" class="c-back-page-icon-link"></a>
    </div>
<!----end of reusable component----->

<h1 class="c-admin-DELETE-tour-dates-CONFIRM-title">Confirm News Story Deletion</h1>
...
$delNewsStory_sql="SELECT * FROM News_table WHERE id=".$_GET['newsID'];

$delNewsStory_query= mysqli_query($dbc, $delNewsStory_sql)
or die('Error querying database.');
$delNewsStory_rs = mysqli_fetch_array($delNewsStory_query);
...
?>
 	  ...
 	  <div class="c-latest-news-articles-photo-container ">
 	  	<img src="../img/<?php echo $delNewsStory_rs['img_ref']?>" class="c-latest-news-articles-photo-img"/>
 	  </div>
 	  ...
 	  <div class="c-latest-news-articles-text-container c-latest-news-articles-text-container--text-align">
 	  	...
 	  	<div class="c-latest-news-articles-body">
 	  		<div class="articles-date"><?php echo $delNewsStory_rs['date']?>
 	  	</div>
 	  </div>

 	  	<h3 class=c-latest-news-sub-title><?php echo $delNewsStory_rs['title']?></h3>

 	  	<p><?php echo $delNewsStory_rs['description']?> </p>
...
<p class="c-admin-confirm-add-tour-desc"><a class="c-admin-confirm-add-tour-desc-links" href="defDeleteNewsStory.php?newsID=<?php echo $_GET['newsID'];?>">Yes, delete it!</a> |
<a href="deleteNewsStory.php" class="c-admin-confirm-add-tour-desc-links">No, go back</a> | <a href="admin.php" class="c-admin-confirm-add-tour-desc-links">Back to control panel</a></p>
