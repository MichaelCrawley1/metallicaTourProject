...
$theUnlink_image_sql ="SELECT * FROM News_table WHERE id=".$_GET['newsID'];
...
// now we are free to delete the application and re use that image if we want to later.  
 ...
 $delNewsStory_query= mysqli_query($dbc,$delNewsStory_sql) or die('Error querying database.');
...
<h1 class="c-admin-confirmation-page-title">The News Story has successfully been Deleted!!!!!</h1>
