...
<h1 class="c-admin-DELETE-tour-dates-title">Delete Music Album</h1>
...
while ($delMusic_rs = mysqli_fetch_array($delMusic_query)){ ?>
	...
	<article class="c-news-stories-DELETE-container">
 	 ...
 	 <!---the, 'c-music-DELETE-img-album-change' class is in its own comparted sass file---->
 	  	<img class="c-news-stories-DELETE-img-itself c-music-DELETE-img-album-change" src="../img/<?php echo $delMusic_rs ['img_ref'];?>" />

 	  	<!---end of the music delete component ---->

 	  	<a class="c-news-stories-DELETE-links-bbc" href="deleteMusicAlbumsConfirm.php?musicID=<?php echo $delMusic_rs['id'];?>">
